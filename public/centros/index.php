...
if ($hasSearch) { $stC->bindValue(':q', $like, PDO::PARAM_STR); }
$stC->execute();
...
";
$st = $pdo->prepare($sql);
if ($hasSearch) { $st->bindValue(':q', $like, PDO::PARAM_STR); }
...
<head>
  <meta charset="utf-8">
  <title>Centros — Practicalia</title>
  ...
  <main class="max-w-6xl mx-auto p-4">
    <div class="mb-4 flex items-center justify-between">
      <form class="flex gap-2" method="get">
        <input name="q" value="<?= h($search) ?>" class="rounded-xl border border-gray-300 p-2" placeholder="Buscar (nombre, ciudad, provincia, CP)">
