<?php
// practicalia/public/empresas/alumno_remove.php
...
try {
  ...
  if (!$isAdmin) {
    ...
    if (!$st->fetch()) throw new RuntimeException('No puedes quitar a este alumno.');
  }

  $pdo->prepare('DELETE FROM empresa_alumnos WHERE empresa_id = :e AND alumno_id = :a')
