...
// schema.org
$orgNodes = $xp->query('//*[@itemscope and (@itemtype="http://schema.org/Organization" or
@itemtype="https://schema.org/Organization" or @itemtype="http://schema.org/LocalBusiness" or
...
$addr = $xp->evaluate('.//*[@itemprop="address" and (@itemtype="http://schema.org/PostalAddress" or
@itemtype="https://schema.org/PostalAddress")]', $org);
if ($addr->length) {
$a = $addr->item(0);
...
// og:title / <title>
    ...
    // Regex mínimos
    if (!$data['email'] && preg_match('/[A-Z0-9._%+\-]+@[A-Z0-9.\-]+\.[A-Z]{2,}/i', $html, $m)) $data['email'] =
    strtolower($m[0]);
